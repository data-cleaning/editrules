...
$D$ that is dissallowed while linear edits define regions in $\mathbb{R}^n$ that
...
variables for inequalities in the consequets. So the vector to minimize over becomes
\begin{equation}
