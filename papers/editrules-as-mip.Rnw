...
In that case it happens that there are hard constraint including both types
...
for larger problems. It very quickly generates very large memory objects and 
