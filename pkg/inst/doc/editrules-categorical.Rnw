...
\maketitle
\begin{abstract}
{\em This vignette is nearly finished. Version 2.0 of the package will have
...
implementation for handling numerical data while this paper is concerned with
...
often required to obey many interrelated consistency rules, effective data
...
use the symbols $\in$, $\prec$ and $\preceq$ for edits and record in set as wel as in 
...
the procedure of \citet{fellegi:1976} for generating implicied edits. This procedure,
